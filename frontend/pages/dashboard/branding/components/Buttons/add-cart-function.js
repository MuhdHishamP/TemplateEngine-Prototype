...
const AddCartButtonFunction = ({ addCartbuttonData, AddCartButtonValueFunction }) => {
    ...
    const SetColorPallete = (color) => {
        SetColor(color.hex);
        AddCartButtonValueFunction(colorId, color.hex)
    }

    const SetCardsValue = (id, value) => {
        AddCartButtonValueFunction(id, value)
    }
        ...
        <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <InputColorForm name="Background Color" type="text" classValue="" placeholder=""
                    value={addCartbuttonData ? addCartbuttonData[0]?.backgroundColor : null} OnFunc={ColorPallete} xId={1} />
                <InputColorForm name="Title Color" type="text" classValue="" placeholder=""
                    value={addCartbuttonData ? addCartbuttonData[0]?.titleColor : null} OnFunc={ColorPallete} xId={2} />
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <InputCardBorderRadius name="Border Radius" type="number" classValue="" placeholder=""
                    value={addCartbuttonData ? addCartbuttonData[0]?.brRadius : null} OnFunc={SetCardsValue} xId={3} />
                <InputCardBorderRadius name="Box Padding" type="number" classValue="" placeholder=""
                    value={addCartbuttonData ? addCartbuttonData[0]?.boxPadding : null} OnFunc={SetCardsValue} xId={4} />
            </div>

            <div className="text-sm font-bold mt-5">Shadows</div>
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <SelectCardsShadows name="Box Shadow" classValue="" placeholder=""
                    value={addCartbuttonData ? addCartbuttonData[0]?.boxShadow : null} OnFunc={SetCardsValue} xId={5} />
                <InputColorForm name="Box Color" type="text" classValue="" placeholder=""
                    value={addCartbuttonData ? addCartbuttonData[0]?.boxShadowColor : null} OnFunc={ColorPallete} xId={6} />
            </div>
...
export default AddCartButtonFunction;