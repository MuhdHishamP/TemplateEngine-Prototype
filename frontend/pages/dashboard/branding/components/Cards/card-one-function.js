...
const CardsOneFunction = ({ cardOneData, CardOneValueFunction }) => {
    ...
    const SetColorPallete = (color) => {
        SetColor(color.hex);
        CardOneValueFunction(colorId, color.hex)
    }

    const SetCardsValue = (id, value) => {
        CardOneValueFunction(id, value)
    }
        ...
        <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <InputColorForm name="Background Color" type="text" classValue="" placeholder=""
                    value={cardOneData ? cardOneData[0]?.cardOne?.backgroundColor : null} OnFunc={ColorPallete} xId={1} />
                <InputColorForm name="Title Color" type="text" classValue="" placeholder=""
                    value={cardOneData ? cardOneData[0]?.cardOne?.titleColor : null} OnFunc={ColorPallete} xId={2} />
                <InputColorForm name="Price Color" type="text" classValue="" placeholder=""
                    value={cardOneData ? cardOneData[0]?.cardOne?.priceColor : null} OnFunc={ColorPallete} xId={3} />
                <InputColorForm name="Category Color" type="text" classValue="" placeholder=""
                    value={cardOneData ? cardOneData[0]?.cardOne?.catColor : null} OnFunc={ColorPallete} xId={4} />
                <InputColorForm name="Discount Color" type="text" classValue="" placeholder=""
                    value={cardOneData ? cardOneData[0]?.cardOne?.disColor : null} OnFunc={ColorPallete} xId={5} />
                <InputColorForm name="Discount Del Color" type="text" classValue="" placeholder=""
                    value={cardOneData ? cardOneData[0]?.cardOne?.disDelColor : null} OnFunc={ColorPallete} xId={6} />
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <InputCardBorderRadius name="Border Radius" type="number" classValue="" placeholder=""
                    value={cardOneData ? cardOneData[0]?.cardOne?.brRadius : null} OnFunc={SetCardsValue} xId={7} />
                <InputCardBorderRadius name="Image Radius" type="number" classValue="" placeholder=""
                    value={cardOneData ? cardOneData[0]?.cardOne?.brRadiusImage : null} OnFunc={SetCardsValue} xId={8} />
                <InputCardBorderRadius name="Image Padding" type="number" classValue="" placeholder=""
                    value={cardOneData ? cardOneData[0]?.cardOne?.imagePadding : null} OnFunc={SetCardsValue} xId={9} />
                <InputCardBorderRadius name="Box Padding" type="number" classValue="" placeholder=""
                    value={cardOneData ? cardOneData[0]?.cardOne?.boxPadding : null} OnFunc={SetCardsValue} xId={10} />
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <SelectCardsShadows name="Image Shadow" classValue="" placeholder=""
                    value={cardOneData ? cardOneData[0]?.cardOne?.imageShadow : null} OnFunc={SetCardsValue} xId={12} />
                <InputColorForm name="Image Color" type="text" classValue="" placeholder=""
                    value={cardOneData ? cardOneData[0]?.cardOne?.imageShadowColor  : null} OnFunc={ColorPallete} xId={13} />
                <SelectCardsShadows name="Box Shadow" classValue="" placeholder=""
                    value={cardOneData ? cardOneData[0]?.cardOne?.boxShadow  : null} OnFunc={SetCardsValue} xId={14} />
                <InputColorForm name="Box Color" type="text" classValue="" placeholder=""
                    value={cardOneData ? cardOneData[0]?.cardOne?.boxShadowColor  : null} OnFunc={ColorPallete} xId={15} />
            </div>
...
export default CardsOneFunction;